...
param_grid_preprocess = {
    'dataset_size': [1772],
    'parallelism_read': [-1, 1, 25, 50, 100, 200],                                      # -1 is the default value
    'num_cpus': [1, 2, 4, 8],                                                      # 0 is the default value
    'batch_size_map_batches': ['default', None, 8, 64, 128, 512, 1024],    # 'default' is the default value
    'preserve_order': [False, True]                                                     # False is the default value
}
...
def evaluate(params):
    ...
    save_metrics_to_csv(metrics, "metrics_torchscript_embl_preprocess.csv", job_id)
